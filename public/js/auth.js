...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (authForm) {
    authForm.addEventListener('submit', async (e) => {
      ...
      try {
        // Clear stale auth state before attempting a new registration/login
        localStorage.removeItem('sportzone_token');
        localStorage.removeItem('sportzone_user');
        ...
        showError('Unable to connect to the server. Please make sure the backend is running and try again.');
      }
    });
  }
